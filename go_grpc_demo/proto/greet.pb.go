...
const file_proto_greet_proto_rawDesc = "" +
	...
	"\bmessages\x18\x01 \x03(\tR\bmessages2\xe0\x02\n" +
	"\fGreetService\x12@\n" +
	"\bSayHello\x12\x16.greet_service.NoParam\x1a\x1c.greet_service.HelloResponse\x12V\n" +
	"\x1bSayHelloServerSideStreaming\x12\x17.greet_service.NameList\x1a\x1c.greet_service.HelloResponse0\x01\x12U\n" +
...
var file_proto_greet_proto_depIdxs = []int32{
	...
	3, // 1: greet_service.GreetService.SayHelloServerSideStreaming:input_type -> greet_service.NameList
	...
	2, // 5: greet_service.GreetService.SayHelloServerSideStreaming:output_type -> greet_service.HelloResponse
